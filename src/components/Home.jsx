...
function Home() {
  return(
    ...
    <Carousel autoPlay infiniteLoop interval={1000} showStatus={false} showThumbs={false} showArrows={false}>
        ...
        <Heading bgColor={"whiteAlpha.700"} color={"black"} {...headingOptions}>Gaming Is Future</Heading>
        </Box>
        <Box w={"full"} h={"100vh"}>
        <Image src={img3} h={"full"} w={"full"} objectFit={'cover'}/>
        <Heading bgColor={"whiteAlpha.700"} color={"black"} {...headingOptions}>Gaming Is console</Heading>
        </Box>
        <Box w={"full"} h={"100vh"}>
        <Image src={img4} h={"full"} w={"full"} objectFit={'cover'}/>
        <Heading bgColor={"whiteAlpha.700"} color={"black"} {...headingOptions}>Night life is fun</Heading>
        </Box>
    ...
    <Container minH={"100vh"} maxW={'container.xl'} p="16">
        ...
        >
        <Image src={img5} h={['40','400']} filter={'hue-rotate(-130deg)'}/>   {/* h contains array which contains phone and computer screen respectively*/}
